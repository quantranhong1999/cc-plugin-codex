...
Resolve `<plugin-root>` as two directories above this `SKILL.md` file. Run this command from the active plugin root as one blocking foreground shell call:
